...
vector<int> cv_misc::camera_enumerate() {
    vector<int> ret;
    VideoCapture cap;
    for (int i = 0; i<4; i++) {
        if(cap.open(i)) {
...
vector<CameraInfo> cv_misc::camera_enumerate2() {
...
string cv_misc::type2str(int type) {
    /*
...
void cv_misc::fx::spotlight(OutputArray _frame, InputArray _sel, float alpha) {
