...
# USAGE
# ------
# add "list(APPEND CMAKE_MODULE_PATH ${CMAKE_SOURCE_DIR}../../path/to/this/file)" to your project
#
...
#   - src/<op-name>_kernel.cc
#   - src/<op-name>_kernel_gpu.cu
#   - src/<op-name>_op.h
#   - src/<op-name>.cc
...
macro(add_tensorflow_cpu_operation op_name)
  ...
  add_library(${op_name}_op SHARED src/${op_name}_kernel.cc src/${op_name}.cc )
...
macro(add_tensorflow_gpu_operation op_name)
  ...
  set(kernel_file "${CMAKE_SOURCE_DIR}/src/${op_name}_kernel.cu")
